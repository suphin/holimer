...
public sealed class ProductionCatalogCreateVM
{
    [Required, StringLength(100), Display(Name = "Malzeme Kodu")]
    public string Code { get; set; } = string.Empty;

    [Required, StringLength(250), Display(Name = "Malzeme Adı")]
    public string Name { get; set; } = string.Empty;

    [Display(Name = "Malzeme Türü")]
    public PrdMaterialType Type { get; set; } = PrdMaterialType.RawMaterial;

    [Range(1, int.MaxValue), Display(Name = "Ana Birim")]
    public int UnitId { get; set; }

    [Display(Name = "Açıklama")]
    public string? Description { get; set; }

    [Display(Name = "Lot Takibi Zorunlu")]
    public bool RequiresLotTracking { get; set; } = true;

    [Display(Name = "Son Kullanma Tarihi Zorunlu")]
    public bool RequiresExpirationDate { get; set; }

    [Display(Name = "Kalite Kontrol / Analiz")]
    public PrdQualityControlRequirement QualityControlRequirement { get; set; }
