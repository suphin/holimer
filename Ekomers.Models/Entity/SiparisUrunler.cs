...
{
	public class SiparisUrunler:BaseEntity
	{
	...
	public class SiparisUrunlerVM : BaseVM
	{
		public int UrunID { get; set; }
		public int SiparisID { get; set; }
		public int TeklifID { get; set; }
		...
		public List<SiparisUrunlerVM> SiparisUrunlerVMListe { get; set; }
		public List<SiparisIskonto> SiparisIskontoListe { get; set; }
	}
}
