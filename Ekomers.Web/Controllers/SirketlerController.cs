...
namespace Ekomers.Web.Controllers
{
	...
	public class SirketlerController : BaseController
	{
		private readonly ISirketlerService _service;
		private string _userId;
		private readonly ApplicationDbContext _context;
		private string ModulAd = "Admin";
		public SirketlerController(UserManager<Kullanici> userManager, RoleManager<Rol> roleManager,
			 ISirketlerService service
		...
		public async Task<IActionResult> Index()
		{
			...
			var model = new SirketlerVM
			{
				SirketlerVMListe = await _service.VeriListele()
			};

			return View(model);
		}
		[HttpPost]
		public async Task<IActionResult> Index(SirketlerVM modelv)
		{
			ViewBag.Modul = ModulAd;
			await ViewBagListeDoldur();
			var model = new SirketlerVM
			{
				SirketlerVMListe = await _service.VeriListele(modelv)
			};
			return View(model);
		}
		...
		public async Task<PartialViewResult> VeriGoruntule(int VeriID = 0, string view = "")
		{
			...
			modelc.ControllerName = "Sirketler";
			modelc.ModalTitle = "Sirketler Birimi";
		...
		[HttpPost]
		public IActionResult VeriEkle(SirketlerVM model)
		{
		...
		[HttpPost]
		[Authorize(Roles = "Editor")]
		public async Task<IActionResult> VeriSil(SirketlerVM model)
		{
