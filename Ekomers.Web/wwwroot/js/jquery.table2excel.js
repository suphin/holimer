...
;(function ( $, window, document, undefined ) {
		...
		Plugin.prototype = {
			init: function () {
				...
				$(e.element).find("tr").not(".noExl").each(function (i, o) {
				   
				    e.tableRows += "<tr>";
				   
				    $($(o).html()).filter("th").not(".noExl").each(function (index, value) {

				        e.tableRows += "<th>" + $(this).html() + "</th>";

				    });

				    $($(o).html()).filter("td").not(".noExl").each(function (index, value) {

				        e.tableRows += "<td>" + $(this).html() + "</td>";
