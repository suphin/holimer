...
{
	public interface IStokService : IGenelService<MalzemeStokVM, MalzemeStok>
    {
		Task<bool> VeriEkleCoklu(MalzemeStokVM modelv);
		Task<bool> VeriEkleTransferCoklu(MalzemeStokVM modelv);
		...
		Task<List<MalzemeStokVM>> VeriListele(MalzemeStokVM model, int departmanID);
		...
		Task<List<MalzemeStokVM>> VeriListele(int departmanID);
